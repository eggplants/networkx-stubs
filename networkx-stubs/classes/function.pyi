...
def nodes(G): ...
def edges(G, nbunch: Any | None = ...): ...
def degree(G, nbunch: Any | None = ..., weight: Any | None = ...): ...
def neighbors(G, n): ...
...
def info(G, n: Any | None = ...): ...
def set_node_attributes(G, values, name: Any | None = ...) -> None: ...
def get_node_attributes(G, name): ...
def set_edge_attributes(G, values, name: Any | None = ...) -> None: ...
def get_edge_attributes(G, name): ...
def all_neighbors(graph, node): ...
def non_neighbors(graph, node): ...
def non_edges(graph) -> Generator[Any, None, None]: ...
...
def selfloop_edges(
    G, data: bool = ..., keys: bool = ..., default: Any | None = ...
): ...
